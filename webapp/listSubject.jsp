...
<body>
    ...
    <div class="container">
        <h2>Subject</h2>
        <button class="btn-add" onclick="location.href='CreateSubjectController'">+ Record</button>
...
<c:forEach var="subject" items="${subjectList}">
    <div class="subject-card">
        ...
        <div class="card-actions">
            ...
            <a href="${pageContext.request.contextPath}/DeleteSubjectController?subjectId=${subject.subjectId}" 
   class="btn-delete" 
